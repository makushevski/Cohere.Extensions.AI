...
{
    /// <summary>
    ///     Adds a Cohere-backed <see cref="Microsoft.Extensions.AI.IChatClient" /> using the provided API key and optional
    ///     default model ID.
    /// </summary>
    ...
    /// <exception cref="InvalidOperationException">Cohere API key is not provided</exception>
    public static IServiceCollection AddCohereChatClient(this IServiceCollection services, string? apiKey = null,
        Action<CohereChatClientOptions>? configure = null)
    {
        ...
        if (string.IsNullOrWhiteSpace(effectiveKey))
            throw new InvalidOperationException(
                "Cohere API key is not provided. Set it via parameter or COHERE_API_KEY environment variable.");
